...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_facet_field 'name_facet', label: 'Subject'
    config.add_facet_field 'repository1_facet', label: 'Contributor'
    ...
    config.add_index_field 'name_field', label: 'Subjects', link_to_search: true
